...
from python.constants import BETA, R, IOTA, TAU, o_range, z_shock_range
from python.distributions import ZDISTRIBUTION, PIMATRIX
    ...
    for epoch in range(EPOCHS):
        ...
        for agent in range(1, AGENTS + 1):
            ...
            if epoch == 0 and agent == 1:
                ...
                _mode = 'a'
                _header = False        
            df.to_csv("data/results_FW.csv", index=False, header =_header, mode= _mode)